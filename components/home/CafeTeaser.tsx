          ...
          <div className="w-full lg:w-7/12 relative">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center sm:items-stretch">
              {menuItems.map((item, index) => (
                <ScrollReveal key={item.id} direction="up" staggerIndex={index} delay={0.2}>
                  <div 
                    className={`relative w-full max-w-[280px] sm:w-full group cursor-pointer ${
            ...
            {/* Third item fallback for mobile */}
            {menuItems[2] && (
