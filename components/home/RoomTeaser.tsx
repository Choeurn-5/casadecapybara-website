      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {rooms.map((room, index) => (
            <ScrollReveal key={room.id} direction="up" staggerIndex={index} delay={0.1}>
              <div 
                className="group flex flex-col bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-350 ease-out h-full"
              >
                {/* Image Container */}
