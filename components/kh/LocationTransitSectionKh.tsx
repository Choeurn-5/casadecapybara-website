...
const destinations = [
  {
    ...
    icon: "🛺",
    modeIcon: Car,
    description: "ប្រាសាទសាសនាធំជាងគេបំផុតនៅលើពិភពលោក និងជាអច្ឆរិយវត្ថុបេតិកភណ្ឌពិភពលោករបស់យូណេស្កូ។",
    highlight: "ផ្លូវធ្វើដំណើរដែលពោរពេញដោយទេសភាពស្អាត",
  },
  {
    name: "កង់វិលអង្គរ (Angkor Eye)",
    time: "៥ នាទី",
    mode: "ដើរ",
    icon: "🚶",
    modeIcon: Footprints,
    description: "កង់វិលកម្ពស់ ៨៥ ម៉ែត្រ ដែលអាចមើលឃើញទេសភាពក្រុងសៀមរាបទាំងមូល។",
    highlight: "ដើរកម្សាន្តតាមសួនច្បារយ៉ាងងាយស្រួល",
  },
  {
    name: "រោងមហោស្រពរស្មី (Robam Theater)",
    time: "៥ នាទី",
    mode: "ដើរ",
    icon: "🚶",
    modeIcon: Footprints,
    description: "ទស្សនាការសម្តែងរបាំបុរាណខ្មែរ និងកម្មវិធីវប្បធម៌។",
    highlight: "នៅក្បែរនេះផ្ទាល់",
  },
  {
    name: "ផាប់ស្ទ្រីត និងផ្សាររាត្រី",
    time: "១០ នាទី",
    mode: "រ៉ឺម៉កកង់បី",
    icon: "🛺",
    modeIcon: Car,
    description: "ដើរកម្សាន្តតាមមាត់ស្ទឹង ទិញវត្ថុអនុស្សាវរីយ៍ និងញ៉ាំអាហារពេលរាត្រីយ៉ាងសប្បាយរីករាយ។",
    highlight: "ធ្វើដំណើរដោយកង់បីយ៉ាងរហ័ស",
  },
];

export default function LocationTransitSectionKh() {
          ...
          <div className="max-w-2xl">
            <ScrollReveal direction="up" staggerIndex={0}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1B5E20]/10 border border-[#1B5E20]/20 text-[#1B5E20] text-xs font-bold tracking-widest uppercase mb-4">
                ...
                <span>ទីតាំងល្អបំផុតនៅសៀមរាប</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" staggerIndex={2}>
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                ពេលដើរកម្សាន្តតាមប្រាសាទរួចរាល់ហើយមែនទេ? យើងមានទីតាំងនៅលើផ្លូវក្រវ៉ាត់ក្រុង ចុះពីផ្លូវជាតិលេខ ៦ តែប៉ុន្មាននាទីប៉ុណ្ណោះ។ មកលំហែកាយជាមួយសត្វកាពីបារ៉ា ញ៉ាំកាហ្វេ និងយកកម្លាំងត្រលប់មកវិញ។
              </p>
            </ScrollReveal>
          </div>
          ...
          <div className="relative w-full h-80 sm:h-96 rounded-3xl overflow-hidden shadow-2xl border border-[#1B5E20]/15 bg-[#131A15] group">
            ...
            <div className="absolute top-4 left-4 z-10 pointer-events-none">
              <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/95 backdrop-blur-md border border-[#1B5E20]/20 shadow-lg text-xs font-semibold text-[#1A2E1C]">
                ...
                <span>ផ្លូវក្រវ៉ាត់ក្រុង (ចុះពីផ្លូវជាតិលេខ ៦) ក្រុងសៀមរាប</span>
              </div>
            </div>
          </div>
        </ScrollReveal>
