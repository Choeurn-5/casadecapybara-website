...
interface AboutSectionKhProps {
  sovrinBadgeImg?: string;
  tripadvisorBadgeImg?: string;
  googleBadgeImg?: string;
}

export default function AboutSectionKh({
  sovrinBadgeImg,
  tripadvisorBadgeImg,
  googleBadgeImg,
}: AboutSectionKhProps) {
  return (
    <section className="relative w-full py-20 sm:py-28 bg-[#FDFBF7] text-[#1A2E1C] overflow-hidden border-b border-[#1B5E20]/10 font-battambang">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <ScrollReveal direction="up" staggerIndex={0}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1B5E20]/10 border border-[#1B5E20]/20 text-[#1B5E20] text-xs font-bold tracking-widest uppercase mb-5">
                ...
                <span>បង្កើតឡើងនៅខែមករា ឆ្នាំ២០២៦ • សៀមរាប, កម្ពុជា</span>
              </div>
            </ScrollReveal>

            {/* Headline */}
            <ScrollReveal direction="up" staggerIndex={1}>
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold tracking-tight text-[#1A2E1C] leading-[1.3] mb-6">
                រាល់ការមកដល់របស់អ្នក <br />
                <span className="text-[#1B5E20]">
                  នឹងក្លាយជាអនុស្សាវរីយ៍
                </span>
              </h2>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" staggerIndex={2}>
              <p className="text-lg sm:text-xl font-medium text-gray-800 leading-relaxed mb-6 border-l-2 border-[#E65100] pl-4">
                ជាកន្លែងសម្រាកលំហែកាយបែបធម្មជាតិដ៏ស្ងប់ស្ងាត់ ដែលចំណាយពេលត្រឹមតែប៉ុន្មាននាទីពីប្រាសាទអង្គរវត្ត។
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" staggerIndex={3}>
              <div className="space-y-4 text-sm sm:text-base text-gray-600 leading-relaxed mb-8 max-w-2xl">
                <p>
                  បានបើកដំណើរការនៅក្នុង <strong>ខែមករា ឆ្នាំ២០២៦</strong>, Casa de Capybara ត្រូវបានបង្កើតឡើងជារីសតបែបធម្មជាតិ និងជាជម្រកសត្វកាពីបារ៉ាដំបូងគេបង្អស់នៅកម្ពុជា។ ស្ថិតនៅកណ្តាលសួនច្បារដ៏ខៀវស្រងាត់ ជិតតំបន់អង្គរ ទីនេះផ្តល់ជូននូវភាពស្ងប់ស្ងាត់ ការយកចិត្តទុកដាក់ខ្ពស់ និងការរស់នៅដោយក្តីស្រលាញ់ជាមួយសត្វកាពីបារ៉ារបស់យើង។
                </p>
                <div className="p-4 rounded-xl bg-[#1B5E20]/5 border border-[#1B5E20]/15 text-[#1A2E1C]">
                  <p className="font-semibold text-[#1B5E20] flex items-center gap-2 mb-1">
                    ...
                    ស្វាគមន៍ភ្ញៀវចូលលេងកម្សាន្តជារៀងរាល់ថ្ងៃ
                  </p>
                  <p className="text-xs sm:text-sm text-gray-700">
                    លោកអ្នកមិនចាំបាច់ជាភ្ញៀវស្នាក់នៅសណ្ឋាគារ ទើបអាចចូលលេងបាននោះទេ។ ភ្ញៀវខាងក្រៅតែងតែត្រូវបានស្វាគមន៍យ៉ាងកក់ក្តៅ ដើម្បីមកពិសាអាហារ ដើរលេងក្នុងសួន និងកក់សំបុត្រលេងជាមួយសត្វកាពីបារ៉ា។
                  </p>
                </div>
              </div>
            </ScrollReveal>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 w-full max-w-xl mb-8 pt-2">
                <div className="p-3.5 rounded-xl bg-white border border-[#1B5E20]/10 shadow-xs">
                  <div className="flex items-center gap-1.5 text-xs text-gray-500 mb-1">
                    ...
                    <span className="font-semibold">បង្កើតឡើងនៅ</span>
                  </div>
                  <div className="text-base sm:text-lg font-bold text-[#1A2E1C]">មករា ២០២៦</div>
                  <div className="text-[11px] text-gray-500">ថ្មីស្រឡាង</div>
                </div>

                <div className="p-3.5 rounded-xl bg-white border border-[#1B5E20]/10 shadow-xs">
                  <div className="flex items-center gap-1.5 text-xs text-gray-500 mb-1">
                    <MapPin className="w-3.5 h-3.5 text-[#1B5E20]" />
                    <span className="font-semibold">ទីតាំង</span>
                  </div>
                  <div className="text-base sm:text-lg font-bold text-[#1A2E1C]">១៥ នាទី</div>
                  <div className="text-[11px] text-gray-500">ពីអង្គរវត្ត</div>
                </div>

                <div className="p-3.5 rounded-xl bg-white border border-[#1B5E20]/10 shadow-xs">
                  <div className="flex items-center gap-1.5 text-xs text-gray-500 mb-1">
                    <Heart className="w-3.5 h-3.5 text-[#E65100]" />
                    <span className="font-semibold">បើកទ្វារ</span>
                  </div>
                  <div className="text-base sm:text-lg font-bold text-[#1A2E1C]">រៀងរាល់ថ្ងៃ</div>
                  <div className="text-[11px] text-gray-500">អាចទិញសំបុត្របាន</div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" staggerIndex={5}>
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <span>បទពិសោធន៍ជាមួយកាពីបារ៉ា</span>
                </Link>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" staggerIndex={0} delay={0.1}>
              <div className="flex items-center justify-between mb-1">
                <p className="text-xs font-bold uppercase tracking-widest text-[#1B5E20] flex items-center gap-2">
                  ...
                  <span>ការទទួលស្គាល់ និងការសរសើរពីភ្ញៀវ</span>
                </p>
                <span className="text-[11px] font-medium text-gray-500">ភស្តុតាងច្បាស់លាស់</span>
              </div>
            </ScrollReveal>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-xs text-gray-600 font-medium">កម្ពុជា</span>
                    </div>

                    <h3 className="text-base sm:text-lg font-bold text-[#1A2E1C] mt-1 group-hover:text-[#1B5E20] transition-colors">
                      លេចធ្លោលើទស្សនាវដ្តីសូវរីន (Sovrin)
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mt-1">
                      ត្រូវបានលើកសរសើរដោយទស្សនាវដ្តីឈានមុខគេនៅកម្ពុជា ថាជាគោលដៅទេសចរណ៍ដ៏ល្អបំផុតសម្រាប់ការកម្សាន្ត និងសណ្ឋាគារបែបធម្មជាតិ។
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="inline-flex items-center text-xs text-gray-600 group-hover:text-[#00AA6C] font-semibold transition-colors">
                        មើលការវាយតម្លៃ <ExternalLink className="w-3 h-3 ml-1" />
                      </span>
                    </div>

                    <h3 className="text-base sm:text-lg font-bold text-[#1A2E1C] mt-1 group-hover:text-[#00AA6C] transition-colors">
                      ការវាយតម្លៃដ៏ល្អឥតខ្ចោះ
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mt-1">
                      ជាប់ចំណាត់ថ្នាក់ខ្ពស់បំផុតក្នុងចំណោមបទពិសោធន៍ទេសចរណ៍ និងសណ្ឋាគារល្អបំផុតនៅក្នុងក្រុងសៀមរាប។
                    </p>
                  </div>
                </div>
              </a>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-bold text-gray-800 ml-1">ផ្កាយ 4.9</span>
                      </div>
                      <span className="inline-flex items-center text-xs text-gray-600 group-hover:text-[#4285F4] font-semibold transition-colors">
                        372+ ការវាយតម្លៃ <ExternalLink className="w-3 h-3 ml-1" />
                      </span>
                    </div>

                    <h3 className="text-base sm:text-lg font-bold text-[#1A2E1C] mt-1 group-hover:text-[#4285F4] transition-colors">
                      Google Reviews (ផ្កាយ 4.9)
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mt-1">
                      ទទួលបានការវាយតម្លៃផ្កាយ ៥ រាប់រយដង អំពីសត្វកាពីបារ៉ាដ៏សែនស្លូត ការបម្រើដ៏ល្អ និងហាងកាហ្វេដ៏ឈ្ងុយឆ្ងាញ់។
                    </p>
                  </div>
                </div>
              </a>
            ...
            <ScrollReveal direction="up" staggerIndex={4} delay={0.3}>
              <div className="relative w-full h-44 sm:h-48 rounded-2xl overflow-hidden shadow-md border border-[#1B5E20]/15 group">
                ...
                <div className="absolute bottom-3 left-4 right-4 text-white text-xs flex items-center justify-between">
                  <span className="font-medium drop-shadow-sm">ជម្រករបស់ Molly និង Alex</span>
