            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-[#E8F5E9]">
              ...
              <div className="space-y-3">
                <a 
                  ...
                  className="flex items-center justify-center gap-2 w-full text-center py-4 bg-[#E65100] hover:bg-[#d84315] text-white font-bold rounded-2xl transition-all shadow-lg shadow-[#E65100]/25 hover:-translate-y-0.5 text-sm sm:text-base active:scale-[0.99]"
                >
